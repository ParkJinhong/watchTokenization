...
📄 **기획·리스크 분석 → [문서(HTML)](docs/시계토큰화_기획_리스크.html)** · 🗺️ **시스템 구조도 → [전체 구조도](docs/구조도.html)** · 시장별: [A. 토큰화 시장](docs/구조도_토큰화시장.html) · [B. 대출 시장](docs/구조도_대출시장.html) (브라우저에서 열기 / Ctrl+P로 PDF 저장)
